...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/nr.preconditions-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13601&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/nr.preconditions-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `nr.preconditions` can be installed with:

```
conda install nr.preconditions
```

It is possible to list all of the versions of `nr.preconditions` available on your platform with:
